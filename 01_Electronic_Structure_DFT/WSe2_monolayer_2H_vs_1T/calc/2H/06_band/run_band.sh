#!/bin/bash
#===============================================================================
#SBATCH -J 2H-WSe2_band         # job name
#SBATCH -o 2H-WSe2_band.o%j     # output and error file name (%j expands to jobID)
#-----------------------------
...
cp INCAR.band INCAR; cp KPT.band KPOINTS

mpirun -np $SLURM_NTASKS $VASP > stdout

mv stdout std.band; mv OUTCAR out.band
mv PROCAR pro.band; mv EIGENVAL eig.band
